...
class CategoryCollection extends JsonResource
{
    ...
    {   
         ...
         */ 
        $endUrl = Route::currentRouteName() === 'transactions.categories.index' || Route::currentRouteName() === 'buyers.categories.index' || Route::currentRouteName() === 'sellers.categories.index'
